...
def test_model_config_to_envs_thinking_disabled():
...
def test_builtin_agent_defaults():
    agent = BuiltInAgent()
...
def test_builtin_agent_custom_model():
...
def test_builtin_agent_model_instances_not_shared():
    a = BuiltInAgent()
    b = BuiltInAgent()
...
def test_custom_agent_requires_agent_code_directory():
    with pytest.raises(TypeError):
        CustomAgent()  # type: ignore[call-arg]


def test_custom_agent_defaults():
...
def test_custom_agent_custom_values():
    agent = CustomAgent(
...
def test_custom_agent_environment_variables_not_shared():
...
def test_agent_core_properties_requires_runtime_name():
    with pytest.raises(TypeError):
        AgentCoreProperties()  # type: ignore[call-arg]


def test_agent_core_properties_defaults():
...
def test_agent_core_properties_builtin_agent_mode():
...
def test_agent_core_properties_custom_agent_mode():
    props = AgentCoreProperties(
        runtime_name="test",
        agent=CustomAgent(
